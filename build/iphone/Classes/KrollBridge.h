...
@interface TiUICommonJSModuleWrapperObject : KrollCoverageObject {
#else
@interface TiUICommonJSModuleWrapperObject : KrollObject {
#endif
@private
...
extern NSString * TiUICommonJSModuleWrapper$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TiUICommonJSModuleWrapperObject *_tiuicommonjsmodulewrapper;
	BOOL shutdown;
