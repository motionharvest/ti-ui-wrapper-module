...
// in simulator we redefine to format for TiUICommonJSModuleWrapper Developer console
...
{\
	NSString * exceptionName = [@"org.tiuicommonjsmodulewrapper." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tiuicommonjsmodulewrapper";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITiUICommonJSModuleWrapperNativeItemNone = -1, 
	UITiUICommonJSModuleWrapperNativeItemSpinner = -2,
	UITiUICommonJSModuleWrapperNativeItemProgressBar = -3,
	
	UITiUICommonJSModuleWrapperNativeItemSlider = -4,
	UITiUICommonJSModuleWrapperNativeItemSwitch = -5,
	UITiUICommonJSModuleWrapperNativeItemMultiButton = -6,
	UITiUICommonJSModuleWrapperNativeItemSegmented = -7,
	
	UITiUICommonJSModuleWrapperNativeItemTextView = -8,
	UITiUICommonJSModuleWrapperNativeItemTextField = -9,
	UITiUICommonJSModuleWrapperNativeItemSearchBar = -10,
	
	UITiUICommonJSModuleWrapperNativeItemPicker = -11,
	UITiUICommonJSModuleWrapperNativeItemDatePicker = -12,
	
	UITiUICommonJSModuleWrapperNativeItemInfoLight = -13,
	UITiUICommonJSModuleWrapperNativeItemInfoDark = -14,
	
	UITiUICommonJSModuleWrapperNativeItemDisclosure = -15,
	
	UITiUICommonJSModuleWrapperNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TiUICommonJSModuleWrapper instances of
