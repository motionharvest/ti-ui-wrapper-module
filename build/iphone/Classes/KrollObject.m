 ...
 * Copyright (c) 2009-2011 by TiUICommonJSModuleWrapper, Inc. All Rights Reserved.
...
//@interface TiUICommonJSModuleWrapperObject : NSObject
//@end

@interface TiUICommonJSModuleWrapperObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiUICommonJSModuleWrapperObject class]])
		{
			for (NSString *key in [[(TiUICommonJSModuleWrapperObject*)o modules] allKeys])
			{
