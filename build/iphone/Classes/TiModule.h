...
/**
 The base class for all TiUICommonJSModuleWrapper modules
 */
...
/**
 TiUICommonJSModuleWrapper Platform calls this method on startup.
 */
-(void)startup;

/**
 TiUICommonJSModuleWrapper Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 TiUICommonJSModuleWrapper Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 TiUICommonJSModuleWrapper Platform calls this method on resume.
 @param sender The sender of the event.
 */
