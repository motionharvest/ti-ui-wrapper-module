...
//Rare exceptions to indicate a bug in the _tiuicommonjsmodulewrapper code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TiUICommonJSModuleWrapper proxies.
 */
